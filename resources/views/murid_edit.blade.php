    ...
    <div class="app-main__inner">
        ...
        <div class="main-card mb-3 card">
            <div class="card-body">
                ...
                <form class="needs-validation" action="{{ route('murid.update', $datas->id) }}" method="post">
                  {{ csrf_field() }}
                  {{ method_field('PUT') }}
                    <div class="form-row">
                        <div class="col-md-4 mb-3">
                            <label for="validationCustom01">Nama Siswa</label>
                            <input type="text" class="form-control" id="validationCustom01" placeholder="Full Name" name="nama_murid" value="{{ $datas->nama_murid }}">
                        </div>
                        <div class="col-md-4 mb-3">
